...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dominoCtrl = __webpack_require__(1);

	var _studentsCtrl = __webpack_require__(2);

	var _dataService = __webpack_require__(7);

	__webpack_require__(3);

	angular.module('testApp', ['ngRoute']).controller('DominoCtrl', _dominoCtrl.DominoCtrl).controller("StudentsCtrl", _studentsCtrl.StudentsCtrl).service('dataService', _dataService.dataService).config(function ($routeProvider) {
...
/***/ function(module, exports) {
	...
	exports.DominoCtrl = DominoCtrl;
	function DominoCtrl($scope) {
		var dominoSection = $('.domino-section'),
...
/***/ function(module, exports) {
	...
	exports.StudentsCtrl = StudentsCtrl;
	function StudentsCtrl($scope, dataService) {
		...
		dataService.getJSON(function (response, callback) {
...
/***/ function(module, exports) {
	...
	function dataService($http) {
		this.getJSON = function (callback, arg) {
			$http.get("./data/students.json").then(callback);
		};
	}
